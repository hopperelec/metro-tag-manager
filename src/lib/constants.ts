...
export const METRO_LINES: Record<string, (keyof typeof METRO_STATION_CODES)[]> = {
  "yellow": ["SJM", "MTW", "MAN", "BYK", "CRD", "WKG", "WSD", "HDR", "HOW", "PCM", "MWL", "NSH", "TYN", "CUL", "WTL", "MSN", "WMN", "SMR", "NPK", "PMV", "BTN", "FLE", "LBN", "SGF", "ILF", "WJS", "JES", "HAY", "MTS", "CEN", "GHD", "GST", "FEL", "HTH", "PLW", "HEB", "JAR", "BDE", "SMD", "TDK", "CHI", "SSS"],
  "green": ["APT", "CAL", "BFT", "KSP", "FAW", "WBR", "RGC", "SGF", "ILF", "WJS", "JES", "HAY", "MTS", "CEN", "GHD", "GST", "FEL", "HTH", "PLW", "FGT", "BYW", "EBO", "SBN", "SFC", "MSP", "SUN", "PLI", "UNI", "MLF", "PAL", "SHL"]
};
...
export const CONTEXT_TAGS: AutocompleteTag[] = [
  ...
  ...Object.entries(METRO_STATION_CODES)
...
export const TRAIN_TAGS: AutocompleteTag[] = [
  ...
  ...Array.from({ length: 46 }, (_, i) => ({ name: `555${String(i + 1).padStart(3, "0")}`, implies: ["class 555"] })),
  ...
  ...Array.from({ length: 3 }, (_, i) => ({ name: `BL${i}`, implies: ["battery loco"] })),
  ...
  { name: "platform" },
  ...Array.from({ length: 4 }, (_, i) => ({ name: `platform ${i + 1}`, implies: ["platform"] })),
  { name: "depot" },
  ...
  { name: "not in service" },
  { name: "not stopping", implies: ["not in service", "arriving", "departing"] },
  ...
  ...Array.from({ length: 15 }, (_, i) => ({ name: `T${i + 121}`, implies: ["yellow line service"] })),
  { name: "green line service", implies: ["passenger service"], emoji: "🟢" },
  ...Array.from({ length: 12 }, (_, i) => ({ name: `T${i + 101}`, implies: ["green line service"] })),
  { name: "additional service", implies: ["passenger service"] },
  ...Array.from({ length: 59 }, (_, i) => ({ name: `T${i + 140}`, implies: ["additional service"] })),
